...
genresDict = [
	...
	"Casual", "Action", "Indie", "Experience", "God Game", "Split Screen",
	"Match 3", "Grand Strategy", "Inventory Management", "Moddable",
	"Abstract", "Classic", "Replay Value", "Stylized", "Great Soundtrack",
	"Crowdfunded", "Kickstarter", "Touch-Friendly", "NSFW", "Mature",
	"Controller", "Family Friendly"
]
